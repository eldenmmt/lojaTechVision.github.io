...
<html lang="en">
	<head>
		...
		<title>Electro - HTML Ecommerce Template</title>
 		...
 		<!-- Slick -->
 		<link type="text/css" rel="stylesheet" href="tema/css/slick.css"/>
 		<link type="text/css" rel="stylesheet" href="tema/css/slick-theme.css"/>

 		<!-- nouislider -->
 		<link type="text/css" rel="stylesheet" href="tema/css/nouislider.min.css"/>
	...
	<body>
		...
		<script src="tema/js/nouislider.min.js"></script>
		<script src="tema/js/jquery.zoom.min.js"></script>
